...
package sinaweibo.common.iterator.sequencefile;
...
public final class PathFilters {
	...
	private static final PathFilter TRAIN_FILE_INSTANCE = new PathFilter() {
		@Override
		public boolean accept(Path path) {
			String name = path.getName();
			return name.startsWith("train-") && !name.endsWith(".crc");
		}
	};

	private static final PathFilter TEST_FILE_INSTANCE = new PathFilter() {
		@Override
		public boolean accept(Path path) {
			String name = path.getName();
			return name.startsWith("test-") && !name.endsWith(".crc");
		}
	};
  ...
  private PathFilters() {
	...
	public static PathFilter trainFilter() {
		return TRAIN_FILE_INSTANCE;
	}

	public static PathFilter testFilter() {
		return TEST_FILE_INSTANCE;
	}
