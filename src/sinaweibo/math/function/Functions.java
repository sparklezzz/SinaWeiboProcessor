 ...
 * {@link org.math.function.mahout.math.function.DoubleFunction}, binary functions of type {@link
 * org.math.function.mahout.math.function.DoubleDoubleFunction}. All can be retrieved via <tt>public static final</tt>
 ...
 * argument. See methods {@link #bindArg1(org.math.function.mahout.math.function.DoubleDoubleFunction ,double)} and {@link
 * #bindArg2(org.math.function.mahout.math.function.DoubleDoubleFunction ,double)}. The order of arguments can
 * be swapped so that the first argument becomes the
 * second and vice-versa. See method {@link #swapArgs(org.math.function.mahout.math.function.DoubleDoubleFunction)}.
 ...
 * #chain(org.math.function.mahout.math.function.DoubleFunction , org.math.function.mahout.math.function.DoubleFunction)}:
 ...
 * #chain(org.math.function.mahout.math.function.DoubleFunction , org.math.function.mahout.math.function.DoubleDoubleFunction)}:
 * <ul> <li><tt>Functions.chain(g,f);</tt> </ul> The binary function
 * <tt>f(g(a),h(b))</tt> can be generated via
 * {@link #chain(org.math.function.mahout.math.function.DoubleDoubleFunction , org.math.function.mahout.math.function.DoubleFunction ,
 * org.math.function.mahout.math.function.DoubleFunction)}: <ul>
