...
import sinaweibo.vectorizer.DefaultAnalyzer;
import sinaweibo.vectorizer.DocumentProcessor;
...
public final class CollocDriver extends AbstractJob {
  ...
  /**
   * Generate all ngrams for the {@link sinaweibo.vectorizer.DictionaryVectorizer} job
   * 
   * @param input
