...
package sinaweibo.vectorizer.collocations.llr;
  ...
  protected void map(Text key, StringTuple value, final Context context) throws IOException, InterruptedException {
    ...
    try {
      ...
      HashMap<String, Integer> ngrams =
              new HashMap<String, Integer>(value.getEntries().size() * (maxShingleSize - 1));
      HashMap<String, Integer> unigrams = new HashMap<String, Integer>(value.getEntries().size());
