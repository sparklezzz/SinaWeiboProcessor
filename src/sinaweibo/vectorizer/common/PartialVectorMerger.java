...
package sinaweibo.vectorizer.common;
...
public final class PartialVectorMerger {
  ...
  /**
   * Merge all the partial {@link sinaweibo.math.RandomAccessSparseVector}s into the complete Document
   * {@link sinaweibo.math.RandomAccessSparseVector}
   * 
